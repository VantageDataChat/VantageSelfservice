...
(function () {
    ...
    var translations = {
        'zh-CN': {
            ...
            'admin_multimodal_sensevoice': 'SenseVoice 配置',
            'admin_multimodal_sensevoice_path': 'SenseVoice 可执行文件路径',
            'admin_multimodal_sensevoice_path_hint': '填写 sense-voice-cpp 的完整路径，如 /usr/local/bin/sense-voice-cpp',
            'admin_multimodal_sensevoice_model': 'SenseVoice 模型文件路径',
            'admin_multimodal_sensevoice_model_hint': '填写模型文件（model.bin）的完整路径',
            'admin_multimodal_sensevoice_install': '📦 SenseVoice.cpp 安装指南',
            'admin_multimodal_sensevoice_desc': 'SenseVoice.cpp 是轻量级的 C++ 语音识别工具，无需 Python 环境，易于部署。',
            'admin_multimodal_sensevoice_step1_title': '步骤 1：下载预编译程序',
            'admin_multimodal_sensevoice_step1_desc': '从 <a href="https://github.com/lovemefan/SenseVoice.cpp/releases" target="_blank" rel="noopener">GitHub Releases</a> 下载适合您系统的预编译版本（Windows/Linux/macOS）',
            'admin_multimodal_sensevoice_step1_alt': '或使用源码编译：<code>git clone https://github.com/lovemefan/SenseVoice.cpp && cd SenseVoice.cpp && mkdir build && cd build && cmake .. && make</code>',
            'admin_multimodal_sensevoice_step2_title': '步骤 2：下载模型文件',
            'admin_multimodal_sensevoice_step2_desc': '从项目的 <a href="https://github.com/lovemefan/SenseVoice.cpp#models" target="_blank" rel="noopener">模型下载页面</a> 获取 model.bin 文件',
            'admin_multimodal_sensevoice_step2_note': '推荐使用 small 模型，平衡了速度和精度',
            'admin_multimodal_sensevoice_step3_title': '步骤 3：配置路径',
            'admin_multimodal_sensevoice_step3_desc': '在上方填写可执行文件和模型文件的完整路径即可',
            'admin_multimodal_sensevoice_note_title': '⚠️ 注意事项',
            'admin_multimodal_sensevoice_note1': 'SenseVoice 依赖 FFmpeg 提取音频，请确保 FFmpeg 已安装',
            'admin_multimodal_sensevoice_note2': 'C++ 实现，无需 GPU 也能快速运行',
            'admin_multimodal_sensevoice_note3': '命令行驱动，部署简单，资源占用低',
        ...
        'en-US': {
            ...
            'admin_multimodal_sensevoice': 'SenseVoice Settings',
            'admin_multimodal_sensevoice_path': 'SenseVoice Executable Path',
            'admin_multimodal_sensevoice_path_hint': 'Enter full path to sense-voice-cpp executable, e.g., /usr/local/bin/sense-voice-cpp',
            'admin_multimodal_sensevoice_model': 'SenseVoice Model File Path',
            'admin_multimodal_sensevoice_model_hint': 'Enter full path to model file (model.bin)',
            'admin_multimodal_sensevoice_install': '📦 SenseVoice.cpp Installation Guide',
            'admin_multimodal_sensevoice_desc': 'SenseVoice.cpp is a lightweight C++ speech recognition tool that requires no Python, easy to deploy.',
            'admin_multimodal_sensevoice_step1_title': 'Step 1: Download Pre-built Binary',
            'admin_multimodal_sensevoice_step1_desc': 'Download the pre-built version for your system (Windows/Linux/macOS) from <a href="https://github.com/lovemefan/SenseVoice.cpp/releases" target="_blank" rel="noopener">GitHub Releases</a>',
            'admin_multimodal_sensevoice_step1_alt': 'Or compile from source: <code>git clone https://github.com/lovemefan/SenseVoice.cpp && cd SenseVoice.cpp && mkdir build && cd build && cmake .. && make</code>',
            'admin_multimodal_sensevoice_step2_title': 'Step 2: Download Model File',
            'admin_multimodal_sensevoice_step2_desc': 'Get model.bin file from the project\'s <a href="https://github.com/lovemefan/SenseVoice.cpp#models" target="_blank" rel="noopener">model download page</a>',
            'admin_multimodal_sensevoice_step2_note': 'Recommended: Use the small model for balanced speed and accuracy',
            'admin_multimodal_sensevoice_step3_title': 'Step 3: Configure Paths',
            'admin_multimodal_sensevoice_step3_desc': 'Enter the full paths to the executable and model file above',
            'admin_multimodal_sensevoice_note_title': '⚠️ Notes',
            'admin_multimodal_sensevoice_note1': 'SenseVoice requires FFmpeg to extract audio. Ensure FFmpeg is installed',
            'admin_multimodal_sensevoice_note2': 'C++ implementation runs fast without GPU',
            'admin_multimodal_sensevoice_note3': 'Command-line driven, simple deployment, low resource usage',
